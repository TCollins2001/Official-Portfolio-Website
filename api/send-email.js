...
res.setHeader("Access-Control-Allow-Origin", "https://tc-web-design-services.com/");
...
if (req.method === "OPTIONS") {
  ...
  const domain = "tc-web-design-services.com";
  
    const businessEmailData = {
      from: "TC WEB DESIGN SERVICES <postmaster@tc-web-design-services.com>",
